% This file reads in a TIFF stack with ground-truth blinking events coming from 
% ThunderSTORM and degrades relying on different noise and compression scenarios. 
% It was majorly meant to get used for benchmarking our software
% The output of this script is a video-file which can directly be read by
% cellSTORM


%% specify the folder where the A to B paris are placed
% define input and output folder
filename_TIF = 'test_density_128_6_parametrs'; % filename for TIF file
filedir_TIF = './Stack_6/' % folder of TIF-file
fname = [filedir_TIF filename_TIF '.tif'];
background_level = 0; % want to add a background signal? 
