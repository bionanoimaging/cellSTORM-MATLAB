...
filename = '/Users/bene/Dropbox/Dokumente/Promotion/PROJECTS/STORM/MATLAB/LINES/cellSTORM_Groundtruth_from_Thunderstorm_13_3_18/MOV2018-03-13-1716real_intred_small.csv';
delimiter = ',';
...
filedir_TIF = '/Users/bene/Dropbox/Dokumente/Promotion/PROJECTS/STORM/MATLAB/LINES/cellSTORM_Groundtruth_from_Thunderstorm_13_3_18/'
...
for i = 1:nframes
    ...
    if(sum(i_frame_events) == 0)
        ...
        try
            ...
            mygt_mes = double(subsample(gaussf(mygt_loc, 7),9));
        end
