...
datapath = './DataFromOriginalVideo/'; % this is the path for both files 
tiff_filename = 'Localizationresult_Made_v2.tif'; % This is the filename for the TIFF-stack (i.e. coming from the experiment, if it's a video, you should convert it to TIF first, because Fiji cannot read MP4
csv_filename = 'Localizationresult_Made_v2.csv'; % This is the localization result which is directly applicable to the TIF-stack, make sure it belongs together!
